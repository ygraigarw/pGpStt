function C=McmcStt(Y,C);
% function C=McmcStt(Y,C);
%
% MCMC for GEV fit, all parameters take form p_0 (constant)
...
for iI=1:C.nItr;
    ...
    if rem(iI,1000)==0;
        ...
        subplot(1,4,3); plot(C.Nll,'k-'); title 'NLL'; pAxsLmt; pDflBig;
        subplot(1,4,4); plot(C.AccRat); title 'Acceptance rates'; pAxsLmt; pDflBig;
        drawnow;
